...
public class TurnOffAllLightsAfterHallDoorClosed implements SensorEventHandler {
    private final SmartHome smartHome;
    private final CommandSender commandSender;

    public TurnOffAllLightsAfterHallDoorClosed(SmartHome smartHome, CommandSender commandSender) {
